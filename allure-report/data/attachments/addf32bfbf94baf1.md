...
- generic [ref=f3e2]:
  - banner [ref=f3e3]:
    - link [ref=f3e6] [cursor=pointer]:
      - /url: http://localhost/opencart/upload/admin/index.php?route=common/login
      - img "OpenCart" [ref=f3e7]
  - generic [ref=f3e12]:
    - heading " Please enter your login details." [level=1] [ref=f3e14]:
      - generic [ref=f3e15]: 
      - text: Please enter your login details.
    - generic [ref=f3e17]:
      - generic [ref=f3e18]:
        - generic [ref=f3e19]: Username
        - generic [ref=f3e20]:
          - generic [ref=f3e21]: 
          - textbox "Username" [ref=f3e23]
      - generic [ref=f3e24]:
        - generic [ref=f3e25]: Password
        - generic [ref=f3e26]:
          - generic [ref=f3e27]: 
          - textbox "Password" [ref=f3e29]
        - link "Forgotten Password" [ref=f3e31] [cursor=pointer]:
          - /url: http://localhost/opencart/upload/admin/index.php?route=common/forgotten
      - button " Login" [ref=f3e33] [cursor=pointer]:
        - generic [ref=f3e34]: 
        - text: Login
  - contentinfo [ref=f3e35]:
    - link "OpenCart" [ref=f3e36] [cursor=pointer]:
